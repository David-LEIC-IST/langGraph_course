...
| Folder | Purpose |
|--------|---------|
| `Graphs/` | Walkthrough notebooks (e.g. hello world, multiple inputs). |
| `Exercises/` | Practice exercises to try on your own. |

## Getting started

1. Use Python 3.10+ (recommended for LangGraph).
2. Create a virtual environment and install dependencies, for example:
   ...
   Add other packages (e.g. `langchain`, model providers) when a notebook needs them.
